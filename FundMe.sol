...
contract FundMe {
    ...
    function fundUSD() public payable {
        ...
        if (addressToAmountFunded[msg.sender] == 0) { // to check if this funder already exists (sent an amount before) in the mapping
    ...
    function getPrice() public view returns (uint256) {
        (
            /*uint80 roundID*/,
            int256 answer, // returns 8 dp, int = int256, uint = uint256
            /*uint startedAt*/,
            /*uint timeStamp*/,
